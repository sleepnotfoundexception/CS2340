 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Calla");
		  toPrint += p1.toString("903112314");
		  ...
		  Person3 p3 = new Person3("Stella");
		  toPrint += p3.toString("903244449");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Jose");
                  toPrint += p4.toString("903356402");
...
>>>>>>> 4926bd3aa492b3ce9e793458446a5d232dc7cc7b
